                ...
                for region in REGION_LIST:
                    # for universe in UNIVERSE_DICT["instrumentType"]['EQUITY']['region'][region]:
                        if mode == "USER":
                            ...
                            sh_th = 1.58
                        need_to_check_alpha = get_alphas(start_date, end_date, sh_th, 1, 10, 10, region=region, universe="", delay='', instrumentType='', alpha_num=9999, usage="submit", tag='', color_exclude='RED')
